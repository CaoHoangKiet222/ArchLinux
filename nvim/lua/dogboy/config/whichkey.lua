...
local mappings = {
  ...
  ["r"] = {
    "<cmd>source ~/.config/nvim/lua/dogboy/core/resources/colorscheme.lua<CR>",
    "Reload monokai-pro",
  },
  ["f"] = {
  ...
  t = {
    ...
    j = { "<cmd>lua _JAVA_RUN_TOGGLE()<cr>", "Java file" },
    J = { "<cmd>lua _JAVA_RUN_WITH_PACKAGE_TOGGLE()<cr>", "Java package" },
